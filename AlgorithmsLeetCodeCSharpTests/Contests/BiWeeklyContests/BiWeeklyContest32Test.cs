...
namespace AlgorithmsLeetCodeCSharpTests.Contests.BiWeeklyContests
{
	...
	{
		BiWeeklyContest32 solution = new BiWeeklyContest32();
		...
		public void Check__(int[] arr, int k, int result)
		{
		...
		[TestCase("()()()()()(", 7)]
		[TestCase("()())))()", 3)]
		public void Check_B_(string s, int result)
		{
			int findKthPositive = solution.MinInsertions(s);
			Assert.AreEqual(result, findKthPositive);
		}
	}
}
